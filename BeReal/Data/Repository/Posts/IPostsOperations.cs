...
namespace BeReal.Data.Repository.Posts
{
    ...
    {
        //Posts
        Task<HomeViewModel> GetHomeViewModel(PageViewModel homePage, string category, string subcategory, string search, string startDate, string endDate, int page, IPostsOperations _postsOperations, IFileManager _fileManager); //apply filters to get the posts
        ...
        Task<BR_Post?> GetBlogPost(string slug); //retrieve a single post to display
