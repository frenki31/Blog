...
namespace BeReal.Data.Repository.Posts
{
    ...
    {
        //Posts
        IQueryable<BR_Post> GetFilteredPosts(string category, string subcategory, string search, DateTime startDate, DateTime endDate);
        ...
        Task<BR_Post?> GetBlogPost(string slug, string category, string subcategory);
